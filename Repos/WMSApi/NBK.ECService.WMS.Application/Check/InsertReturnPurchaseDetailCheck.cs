...
{
    public class InsertReturnPurchaseDetailCheck : BaseCheck
    {
        private CommonResponse rsp = null;
        private ThirdPartyReturnPurchaseDto purchaseDto = null;
        ...
        public InsertReturnPurchaseDetailCheck(CommonResponse rsp, ThirdPartyReturnPurchaseDto purchaseDto, List<sku> skuList, List<skuclass> skuClassList, List<pack> packList, List<uom> uomList)
        {
            this.rsp = rsp;
