...
namespace NBK.ECService.WMSReport.DTO.Other
{
    public class StockTransferLotListDto
    {
        ...
        public string ProduceDateDisplay
        {
            get
            {
                return ProduceDate.HasValue ? ProduceDate.Value.ToString(PublicConst.DateTimeFormat) : string.Empty;
            }
        }
        ...
        public string ExpiryDateDisplay
        {
            get
            {
                return ExpiryDate.HasValue ? ExpiryDate.Value.ToString(PublicConst.DateTimeFormat) : string.Empty;
            }
        }
