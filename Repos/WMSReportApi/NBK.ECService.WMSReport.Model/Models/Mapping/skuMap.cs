...
namespace NBK.ECService.WMSReport.Model.Models.Mapping
{
    public class skuMap : EntityTypeConfiguration<sku>
    {
        public skuMap()
        {
            ...
            this.Property(t => t.OtherUPC1)
                .HasMaxLength(32);

            this.Property(t => t.OtherUPC2)
                .HasMaxLength(32);

            this.Property(t => t.OtherUPC3)
                .HasMaxLength(32);

            this.Property(t => t.OtherUPC4)
                .HasMaxLength(32);

            this.Property(t => t.RecommendLoc)
                .HasMaxLength(32);
