...
namespace NBK.ECService.WMSReport.Model.Models.Mapping
{
    public class assemblyMap : EntityTypeConfiguration<assembly>
    {
        public assemblyMap()
        {
            ...
            this.Property(t => t.PackWeight)
                .HasMaxLength(32);

            this.Property(t => t.PackGrade)
                .HasMaxLength(32);

            this.Property(t => t.StorageConditions)
                .HasMaxLength(64);

            this.Property(t => t.PackSpecification)
                .HasMaxLength(32);

            this.Property(t => t.PackDescr)
                .HasMaxLength(256);
