...
namespace NBK.ECService.WMSReport.Model.Models.Mapping
{
    public class outboundMap : EntityTypeConfiguration<outbound>
    {
        public outboundMap()
        {
            ...
            this.Property(t => t.OutboundGroup)
                .HasMaxLength(32);
            ...
            this.Property(t => t.ConsigneeArea)
                .HasMaxLength(32);
            ...
            this.Property(t => t.OutboundChildType)
                .HasMaxLength(64);

            this.Property(t => t.PlatformOrder)
                .HasMaxLength(32);

            this.Property(t => t.OutboundMethod)
                .HasMaxLength(32);

            this.Property(t => t.PurchaseOrder)
                .HasMaxLength(32);

            this.Property(t => t.TMSOrder)
                .HasMaxLength(32);

            this.Property(t => t.AppointUserNames)
                .HasMaxLength(256);

            this.Property(t => t.ServiceStationCode)
                .HasMaxLength(64);
