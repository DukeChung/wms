...
using NBK.ECService.WMSReport.Model.Models.Mapping;

namespace NBK.ECService.WMSReport.Model
{
    public partial class NBK_WMS_ReportContext : AbpDbContext
    {
        public NBK_WMS_ReportContext() : base("nbk_wms_ReportContext")
        {
        ...
        public DbSet<service_station_receipt> service_station_receipt { get; set; }
        public DbSet<service_station_receipt_detail> service_station_receipt_detail { get; set; }
        ...
        public DbSet<globalmenu> globalmenu { get; set; }

        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            base.OnModelCreating(modelBuilder);
            modelBuilder.Configurations.Add(new globalmenuMap());
            ...
            modelBuilder.Configurations.Add(new service_station_receiptMap());
            modelBuilder.Configurations.Add(new service_station_receipt_detailMap());
