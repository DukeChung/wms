...
namespace WMS.Global.Portal
{
    public static class HtmlHelperExtensions
    {
        ...
        public static IHtmlString RouteIf(this HtmlHelper helper, string value, string controllers, string attribute)
        {
            ...
            var selectContraller = controllers.Equals(currentController, StringComparison.InvariantCultureIgnoreCase);
            ...
            return (hasAction || hasController) && selectContraller ? new HtmlString(attribute) : new HtmlString(string.Empty);
        }
