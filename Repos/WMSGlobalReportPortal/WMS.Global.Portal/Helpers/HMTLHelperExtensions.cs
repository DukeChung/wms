...
namespace WMS.Global.Portal.Helpers
{
    public static class HMTLHelperExtensions
    {
        ...
        public static HtmlString Breadcrumb(this HtmlHelper html, string moduleName, string functionName)
        {
            ...
            strHtml.Append("<div id=\"ribbon1\">");
            strHtml.Append("<span class=\"ribbon-button-alignment\" > ");
            strHtml.Append("<span id =\"refresh\" class=\"btn btn-ribbon\" data-action=\"resetWidgets\" data-title=\"refresh\"> ");
            strHtml.Append("<i class=\"fa fa-refresh\"></i></span></span>");
            strHtml.Append("<ol class=\"breadcrumb\">");
            strHtml.AppendFormat("<li><a href =\"{0}\" >首页</a></li>", "/Home/Index");
            if (!string.IsNullOrEmpty(moduleName))
            {
                strHtml.AppendFormat("<li><a>{0}</a></li>", moduleName);
            }
            if (!string.IsNullOrEmpty(functionName))
            {
                strHtml.AppendFormat("<li class=\"active\"><strong>{0}</strong></li>", functionName);
            }
            strHtml.Append("</ol></div>");
        ...
        public static HtmlString PrintTd(this HtmlHelper html, string tdText = null)
        {
            ...
            strHtml.AppendFormat(
                "  <td  style='padding: 8px;line-height: 1.42857143;vertical-align: top;border-top: 1px solid #ddd;text-align: left;font-family: 宋体;font-size: 12px;'>{0}</td>",
                tdText);
            return new HtmlString(strHtml.ToString());
        }
