    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/jquery").Include(
                        "~/Scripts/jquery-2.1.1.min.js").Include(
                        "~/Scripts/Utility/Extend.js"));
            ...
            // json2
            bundles.Add(new ScriptBundle("~/plugins/json2").Include(
                      "~/Scripts/plugins/json2.min.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/jqGrid").Include(
                      "~/Scripts/plugins/jqGrid/i18n/grid.locale-cn.js",
            ...
            // validate cn message
            bundles.Add(new ScriptBundle("~/plugins/validate/cnMessage").Include(
                      "~/Scripts/plugins/validate/messages_zh.js"));
            ...
            // 条码JS
            bundles.Add(new ScriptBundle("~/plugins/barcode").Include(
                      "~/Scripts/plugins/barcode/jquery-barcode.js"));
            ...
            // Typehead
            bundles.Add(new ScriptBundle("~/plugins/print").Include(
                      "~/Scripts/plugins/print/LodopFuncs.js"));
        }
    }
}
